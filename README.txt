...
Clone from https://svn.code.sf.net/p/pcapsipdump/code/trunk/ with some improvements 

Changes:
- Creating zombie processes after close file triggers was fixed
- Added some %-codes: %L, %q

WARNING
These changes was done with help by AI (DeepSeek).
